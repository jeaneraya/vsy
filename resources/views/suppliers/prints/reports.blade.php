...
<div class="container mt-3">
    <div class="row pb-2">
    <h4 style="border-bottom:1px solid #cbcbcb" class="text-center py-2">Supplier's Ledger</h4>
    <div class="col-7" style="font-size: 13px;">
        <div class="row">
            <div class="col-4">Supplier Name:</div>
            <div class="col-8">{{ $supplier_name }}</div>
        </div>
        <div class="row">
            <div class="col-4">Supplier Address:</div>
            <div class="col-8">{{ $supplier_address }}</div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <table class="table table-striped" style="font-size: 11px;">
            ...
            <tbody>
              @foreach($supplier_trans as $key => $st)
                  <tr>
                      <td>{{ $key + 1 }}</td>
                      <td>{{ $st->trans_date }}</td>
                      <td>{{ $st->ref_no }}</td>
                      <td>{{ $st->trans_description }}</td>
                      <td>&#8369; {{ number_format($st->payments,2) }}</td>
                      <td>&#8369; {{ number_format($st->charges,2) }}</td>
